...
import {CDropdown, CSidebarBrand, CHeaderToggler, CHeaderNav, CDropdownMenu, CDropdownToggle, CDropdownItem} from '@coreui/react';
            ...
            <CHeaderNav className="ml-auto header__margin">
                <Dropdown variant="nav-item">
                    <Dropdown.Toggle placement="bottom-end" className=" py-0 shadow-none header__dropdown">
                        ...
                        <span className="mr-1 header__user-name text-dark">{member ? member.name : null}</span>
                    </Dropdown.Toggle>
                    <Dropdown.Menu placement="bottom-end" className="header__user-name pt-0">
                        <Dropdown.Item onClick={goToMemberProfile} className="header__border"><i className="fa fa-cog header__user-icon"/>
                        ...
                        <Dropdown.Item onClick={languageToggle} className="header__border"><i className="fa fa-language header__user-icon"/>
                            {getFormattedMessage('change-language.title')}
                        </Dropdown.Item>
                        <Dropdown.Item onClick={e => props.onLogout(e)} className="header__border"><i className="fa fa-lock header__user-icon"/>
