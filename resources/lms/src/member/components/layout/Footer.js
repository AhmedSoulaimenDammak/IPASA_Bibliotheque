...
const MemberFooter = ({ appName }) => {
    ...
    return (
        <>
            <div>
                <a href="https://infyom.com" target="_blank" rel="noopener noreferrer"
                   className="text-decoration-none footer-link">{appName}</a>
                <span className="ms-1">&copy; {(new Date().getFullYear())} InfyOmLabs.</span>
            </div>
