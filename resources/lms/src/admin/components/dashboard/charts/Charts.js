            ...
            <Row>
                <Col>
                    <div className="animated fadeIn">
                        <CardColumns className="cols-2 charts__chart-section">
                            <Card>
                                <CardHeader>
                                    {getFormattedMessage('dashboard.chart.circulation-report.title')}
                                </CardHeader>
                                <CardBody className="pb-4">
                                        {renderEmptyDataSet(doughnut.datasets) ? <CChartDoughnut data={doughnut} options={BookCirculationOptions}
                            ...
                            <Card>
                                ...
                                <CardBody className="pb-4">
                                    <div className="chart-wrapper-content">
                                        {renderEmptyDataSet(pie.datasets) ?
                                            <CChartPie data={pie} options={options}/> :
                                            <div className="chart-wrapper-empty-component">
                                                <EmptyComponent isShort title={getFormattedMessage
