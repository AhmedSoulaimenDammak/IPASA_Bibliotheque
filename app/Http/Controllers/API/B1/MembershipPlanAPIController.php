...
class MembershipPlanAPIController extends AppBaseController
{
    ...
    {
        if ($membershipPlan->is_default) {
            return $this->sendResponse($membershipPlan->toArray(), 'Default membership plan should not be updated.');
        }
    ...
    {
        if ($membershipPlan->is_default) {
            return $this->sendResponse($membershipPlan->toArray(), 'Default membership plan should not be deleted.');
        }
