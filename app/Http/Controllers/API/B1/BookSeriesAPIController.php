...
class BookSeriesAPIController extends AppBaseController
{
    ...
    public function update(BookSeries $bookSeries, UpdateBookSeriesRequest $request)
    {
        ...
        if ($bookSeries->is_default) {
            return $this->sendResponse($bookSeries->toArray(), 'Default book series should not be updated.');
        }
    ...
    {
        if ($bookSeries->is_default) {
            return $this->sendResponse($bookSeries->toArray(), 'Default book series should not be deleted.');
        }
