...
class BookLanguageAPIController extends AppBaseController
{
    ...
    {
        if ($bookLanguage->is_default) {
            return $this->sendResponse($bookLanguage->toArray(), 'Default book language should not be updated.');
        }
    ...
    {
        if ($bookLanguage->is_default) {
            return $this->sendResponse($bookLanguage->toArray(), 'Default book language should not be deleted.');
        }
