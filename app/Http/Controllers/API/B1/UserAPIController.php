...
class UserAPIController extends AppBaseController
{
    ...
    {
        if ($user->is_default) {
            return $this->sendResponse($user->toArray(), 'Default user should not be updated.');
        }
    ...
    {
        if ($user->is_default) {
            return $this->sendResponse($user->toArray(), 'Default user should not be deleted.');
        }
    ...
    public function updateUserProfile(UpdateUserProfileRequest $request)
    {
        ...
        $user = $request->user();
        if ($user->is_default) {
            return $this->sendResponse($user->toArray(), 'Default user profile should not be updated.');
        }
