...
class PublisherAPIController extends AppBaseController
{
    ...
    public function update(Publisher $publisher, UpdatePublisherRequest $request)
    {
        if ($publisher->is_default) {
            return $this->sendResponse($publisher->toArray(), 'Default publisher should not be updated.');
        }
    ...
    {
        if ($publisher->is_default) {
            return $this->sendResponse($publisher->toArray(), 'Default publisher should not be deleted.');
        }
