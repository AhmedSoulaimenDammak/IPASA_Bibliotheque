...
class BookRequestAPIController extends AppBaseController
{
     ...
     * @param  UpdateApplyBookRequest  $request
     *
     * @return JsonResponse
     */
    public function update(BookRequest $bookRequest, UpdateApplyBookRequest $request)
    {
        if ($bookRequest->is_default) {
            return $this->sendResponse($bookRequest->toArray(), 'Default book request should not be updated.');
        }
    ...
    {
        if ($bookRequest->is_default) {
            return $this->sendResponse($bookRequest->toArray(), 'Default book request should not be deleted.');
        }
